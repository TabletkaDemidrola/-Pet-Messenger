    ...
    public partial class InitDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friend", x => new { x.UserOneId, x.UserTwoId });
                    table.ForeignKey(
                        name: "FK_Friend_AspNetUsers_UserOneId",
                        column: x => x.UserOneId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Friend_AspNetUsers_UserTwoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrivateChat", x => x.ChatId);
                    table.ForeignKey(
                        name: "FK_PrivateChat_AspNetUsers_UserOneId",
                        column: x => x.UserOneId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PrivateChat_AspNetUsers_UserTwoId",
                        column: x => x.UserTwoId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicChat", x => x.ChatId);
                    table.ForeignKey(
                        name: "FK_PublicChat_Servers_ServerId",
                        column: x => x.ServerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicMessage", x => x.MessageId);
                    table.ForeignKey(
                        name: "FK_PublicMessage_PublicChat_ChatId",
                        column: x => x.ChatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrivateChat_UserOneId",
                table: "PrivateChat",
                column: "UserOneId");

            migrationBuilder.CreateIndex(
                name: "IX_PrivateChat_UserTwoId",
                table: "PrivateChat",
                column: "UserTwoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublicChat_ServerId",
                table: "PublicChat",
                column: "ServerId");

            migrationBuilder.CreateIndex(
                name: "IX_PublicMessage_ChatId",
                table: "PublicMessage",
                column: "ChatId");
